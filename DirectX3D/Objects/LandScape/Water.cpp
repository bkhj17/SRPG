...
void Water::MakeMesh()
{
	...
	vertices.emplace_back(left,	0.0f, top,		0, 0);
	vertices.emplace_back(right,0.0f, top,		1, 0);
	vertices.emplace_back(left, 0.0f, bottom,	0, 1);
	vertices.emplace_back(right,0.0f, bottom,	1, 1);
